...
> **テンプレート**: @.claude/skills/detailed-design-templates/SKILL.md を参照
...
> **GraphQL API**: @.claude/skills/github-graphql-api/SKILL.md を参照
...
> **共通仕様・出力形式**: @.claude/skills/approval-gate/SKILL.md の「ワークフロー完了後の次ステップ選択」を参照
...
| スキル | 用途 |
|--------|------|
| @.claude/skills/detailed-design-templates/SKILL.md | 設計書・Issueテンプレート |
