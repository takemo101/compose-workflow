...
```bash
bash .claude/skills/sanitizer/scripts/sanitize.sh <input-file>
bash .claude/skills/sanitizer/scripts/sanitize.sh --stdin
echo "content" | bash .claude/skills/sanitizer/scripts/sanitize.sh --stdin
```
