...
> **参照元**: 各ワークフロー（req-workflow, basic-design-workflow, detailed-design-workflow）から分離された承認ゲートパターン
...
> **参照**: 合格基準の正式定義は `workflow-phase-convention` skill §レビュースコア閾値を参照
...
| 実装フェーズ | Phase 7.1 | 実装コード | 9点以上 | PR作成へ |
...
| `/detailed-design-workflow` | 実装に進む / 修正 / 終了 | 実装フェーズ |
